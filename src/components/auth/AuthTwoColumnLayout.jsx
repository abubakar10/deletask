...
function AuthTwoColumnLayout({ mode, children }) {
  ...
  return (
    <main className="overflow-x-hidden px-4 py-10 sm:px-6 sm:py-14 lg:py-16">
      <div className="mx-auto max-w-6xl">
        <div className="overflow-hidden rounded-3xl border border-white/10 bg-slate-900 shadow-2xl shadow-black/40">
          <div className="grid min-h-0 min-w-0 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.08fr)] lg:items-stretch">
            <aside className="relative flex h-full min-h-0 min-w-0 flex-col bg-gradient-to-br from-blue-600/25 via-slate-900 to-orange-500/20 p-8 sm:p-10">
            ...
            <section className="flex h-full min-h-0 min-w-0 flex-col border-t border-white/10 bg-slate-950/80 p-6 sm:p-10 lg:border-l lg:border-t-0">
